...
RBAC with 4 roles: Właściciel, Biuro, Produkcja, Magazyn.
"""
...
class Permission:
    ...
    # === WYCENA (Biuro/Właściciel) ===
    VIEW_PRICING = "pricing_view"
    EDIT_PRICING = "pricing_edit"
    APPROVE_PRICING = "pricing_approve"
    
    # === MAGAZYN (Magazyn/Biuro/Właściciel) ===
    VIEW_INVENTORY = "inventory_view"
    EDIT_INVENTORY = "inventory_edit"  # Rezerwacja, spisanie, przyjęcie
    CREATE_PURCHASE = "purchase_create"  # Tworzenie zakupów
    APPROVE_PURCHASE = "purchase_approve"
    EXPORT_INVENTORY = "inventory_export"
    
    # === PRODUKCJA (Produkcja/Biuro/Właściciel) ===
    VIEW_PRODUCTION = "production_view"
    EDIT_PRODUCTION = "production_edit"  # Zmiana statusów produkcji
    VIEW_CALENDAR = "calendar_view"
    EDIT_CALENDAR = "calendar_edit"  # Tylko Produkcja/Właściciel
    
    # === PRACOWNICY (Właściciel) ===
    ...
    CREATE_ALARM_ACTION = "alarms_action"  # Utwórz zakup, spisz itp.
    ...
    # === EXPORT/REPORTS (Biuro/Właściciel) ===
...
# Matryca uprawnień: view / edit / delete / export / approve
ROLE_PERMISSIONS: Dict[str, Set[str]] = {
    ...
    "biuro": {
        # BIURO - Zamówienia, wycena, klienci, raporty (bez ustawień i HR)
        Permission.VIEW_ORDERS, Permission.EDIT_ORDERS, Permission.DELETE_ORDERS,
        Permission.APPROVE_ORDERS, Permission.EXPORT_ORDERS,
        Permission.VIEW_PRICING, Permission.EDIT_PRICING, Permission.APPROVE_PRICING,
        Permission.VIEW_INVENTORY,  # Tylko podgląd magazynu
        Permission.VIEW_PRODUCTION,  # Tylko podgląd produkcji
        Permission.VIEW_CALENDAR,  # Tylko podgląd kalendarza
        Permission.VIEW_WORKERS,  # Tylko lista pracowników
        Permission.VIEW_ALARMS, Permission.RESOLVE_ALARMS, Permission.CREATE_ALARM_ACTION,
        Permission.VIEW_REPORTS, Permission.EXPORT_DATA,
    },
    "magazyn": {
        # MAGAZYN - Pełna kontrola nad magazynem + podgląd zamówień
        Permission.VIEW_ORDERS,  # Podgląd zamówień (do kontekstu)
        ...
        Permission.VIEW_PRODUCTION,  # Podgląd co jest w produkcji
        Permission.VIEW_CALENDAR,
        Permission.VIEW_ALARMS, Permission.RESOLVE_ALARMS, Permission.CREATE_ALARM_ACTION,
    },
    "produkcja": {
        # PRODUKCJA - Kalendarz produkcji, zmiana statusów, swój czas pracy
        Permission.VIEW_ORDERS,  # Podgląd zamówień (do kontekstu)
        Permission.VIEW_PRODUCTION, Permission.EDIT_PRODUCTION,  # Statusy produkcji
        Permission.VIEW_CALENDAR, Permission.EDIT_CALENDAR,  # Swój kalendarz
        Permission.VIEW_WORKERS,  # Lista (tylko podgląd)
        Permission.VIEW_INVENTORY,  # Podgląd dostępnych materiałów
        Permission.VIEW_ALARMS,  # Podgląd alarmów
    },
}
...
def can_access_tab(role: str, tab_title: str) -> bool:
    """
